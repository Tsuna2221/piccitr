    ...
    render() {
        ...
        return (
            <Fragment>
                ...
                <div>
                    <span onClick={() => this.setState({toggleSetting: !toggleSetting})} className={`SearchButton  sett-btn mdi mdi-${toggleSetting ? "close" : "settings"} br-circle c-white cw-fit clickable sd-medium mar-t-14 ${isMobile ? 's-26 pad-14' : 's-22 pad-10'}`}></span>
                </div>
            </Fragment>
        );
    }
